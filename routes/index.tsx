import { Card, ExperienceComponent } from "../components/index.ts";
        ...
        <div className="max-w-screen-lg flex flex-col sm:flex-row items-center sm:justify-between">
          <div className="flex gap-2 items-center">
            <a href="https://github.com/hugomalzieux" target="_blank">
              <IoLogoGithub class="w-6 h-6 text-black hover:text-blue-800 transition duration-150 ease-out hover:ease-in" />
            </a>
            <a
              href="https://www.linkedin.com/in/hugo-malzieux/"
              target="_blank"
            >
              <IoLogoLinkedin class="w-6 h-6 text-black hover:text-blue-700 transition duration-150 ease-out hover:ease-in" />
            </a>
          </div>
          <a href="https://fresh.deno.dev" target="_blank">
            ...
            >
              ...
              <path
                ...
                fill="#232323"
              />
              <rect x=".5" y=".5" width="196" height="36" rx="5.5" />
            </svg>
          </a>
        </div>
      </div>
